/* NurseLink Profile GET Deduplicator v64.1.1
...
(() => {
  ...
  if (window.__NL6411_FETCH_GUARD__) return;
  window.__NL6411_FETCH_GUARD__ = true;
  ...
  document.documentElement.setAttribute('data-nurselink-profile-fetch-guard','v64.1.1');
})();