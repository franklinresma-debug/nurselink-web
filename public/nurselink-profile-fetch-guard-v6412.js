/* NurseLink Profile GET Deduplicator v64.1.2
...
(() => {
  ...
  if (window.__NL6412_FETCH_GUARD__) return;
  window.__NL6412_FETCH_GUARD__ = true;
  ...
  document.documentElement.setAttribute('data-nurselink-profile-fetch-guard','v64.1.2');
})();